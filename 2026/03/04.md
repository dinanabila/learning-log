...
## Accomplishments
- Refresh konsep dictionary python. Dictionary, aku bayanginnya dia versi lebih detailnya dari list. Key nya dictionary, bisa dibayangin ibarat index nya list. Meski udah kayak penerus dari list, tetap ada hal yang berbeda dalam penggunaannya. Contoh yang ga sama, ketika dipanggil pakai for, keluaran antara untuk dictionary dengan list berbeda. kalau for i in list print(i), outputnya kan values di list. tapi kalau for i in dict print(i), outputnya kompilasi key di dict tanpa values nya. 
