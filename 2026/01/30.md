...
## Accomplishments
- "gimana cara model lstm biasa mencerna dan mempelajari data sliding window?" --> sama kayak halnya gimana model ml mencerna dataset yang diterimanya. Semua window nya itu terpakai untuk melatih model lstm, entah itu lstm biasa, maupun lstm seq2seq.
